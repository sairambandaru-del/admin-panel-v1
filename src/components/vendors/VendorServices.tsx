                  ...
                  <TableBody>
                    {filteredBookings.map((booking) => (
                      ...
                      >
                        ...
                        <TableCell className="text-right font-bold text-xs">${booking.amount.toFixed(2)}</TableCell>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="border rounded-xl p-4 bg-card text-xs space-y-2">
                      <div className="flex justify-between">
                        ...
                        <span>${(selectedBooking.amount * 0.9).toFixed(2)}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">Service Fee (10%)</span>
                        <span>${(selectedBooking.amount * 0.1).toFixed(2)}</span>
                      </div>
