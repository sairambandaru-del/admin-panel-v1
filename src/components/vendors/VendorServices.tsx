  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs defaultValue="bookings">
        <TabsList className="grid w-full grid-cols-5 mb<dyad-write path="src/components/vendors/VendorServices.tsx" description="Complete the VendorServices.tsx component with UAE Dirham (AED) currency updates.">
"use client";
